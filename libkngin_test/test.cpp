...
return;
    ...
    server.sin6_scope_id=32;

    inet_pton( AF_INET6, "fe80::26e4:35c1:eea7:68a2", (void *)&server.sin6_addr.s6_addr);
    ...
    int i = 1;
    while (i) {
        n = ::recvfrom(sock,buf,1025,0,(struct sockaddr *)&from,&fromlen);
